...
class BackgroundGenerator:
    ...
    def run(self):
        ...
        prompts_dict = {
    "User Specific":"Design a bright, simple, single or two colours backgorund for a poster with no text",
    ...
    "Educational Workshop": "Generate an image depicting a dynamic educational workshop scenario, featuring a business professional engaged in interactive learning with state-of-the-art technology. Emphasize collaboration, innovation, and the integration of cutting-edge tools within the educational environment. --no text",
    "Health Awareness": "Generate a health awareness background featuring a prominent illustration.Include relevant props such as pills, a balanced diet, and exercise imagery. Emphasize vibrant colors and use persuasive text to convey the importance of a healthy lifestyle for overall well-being.",
